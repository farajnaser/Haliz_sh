...
export default function EverydayStyleSection() {
  return (
    <section className="py-12 md:py-24 px-4 md:px-6 bg-muted/30 dark:bg-card/50 w-full max-w-[95%] mx-auto my-4 md:my-8 rounded-[2rem] md:rounded-[3rem] shadow-sm border border-border overflow-hidden" dir="rtl">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        {/* Header */}
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-2xl md:text-4xl lg:text-6xl font-black text-foreground tracking-tight">
            مصمم لجمالك <span className="text-muted-foreground font-normal">اليومي</span>
          </h2>
          <p className="text-gray-400 font-bold max-w-2xl mx-auto text-sm md:text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 w-full max-w-6xl">
          ...
          <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            {/* Top Left Box */}
            <div className="bg-card p-6 md:p-10 flex flex-col items-center justify-center text-center space-y-4 md:space-y-6 hover:shadow-[0_0_40px_rgba(255,158,203,0.15)] transition-all duration-500 h-[200px] md:h-[280px] rounded-[2rem] border border-border">
            ...
            <div className="group sm:col-span-2 bg-[#ffcbb1] flex flex-col sm:flex-row items-center overflow-hidden h-auto sm:h-[200px] md:h-[280px] rounded-[2rem] transition-all duration-500 hover:shadow-[0_0_50px_rgba(255,158,203,0.2)]">
              ...
              <div className="flex-1 relative w-full h-[160px] sm:h-full">
                <Image
          ...
          <div className="relative md:col-span-1 h-[280px] md:h-[584px] bg-[#e6dcd3] overflow-hidden group rounded-[2rem] md:rounded-[3rem] transition-all duration-700 hover:shadow-[0_0_80px_rgba(255,158,203,0.3)] border border-transparent hover:border-pink-300">
            <Image
